...
app.get("/funciona", (req, res) => {
	res.send("funciona o no funciona?");
});
...
app.get("/pruebados", (req, res) => {
	res.send("esta es la prueba dos");
});
app.listen(PORT, () => {
	console.log("SERVIDOR CORRIENDO chau:" + PORT);
});

app.listen(PORTDOS, () => {
	console.log("HOLA A TODOS desde PORT 4001");
});
